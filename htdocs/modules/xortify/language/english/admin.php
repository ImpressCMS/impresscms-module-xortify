 ...
 */
	...
	define('_XOR_ADMIN_SIGNUP_XORTIFY_H2', 'Signup to the ICMS fortification cloud');
	define('_XOR_ADMIN_SIGNUP_XORTIFY_P', 'Here you can signup to the ICMS fortification cloud called Xortify, the main node for this cloud is featured at http://xortify.com but there can be other nodes, this will prevent spam signup, website harvesting, and general hacking of your site.<br/><br/>It will also share the IP\'s of Bad IP Highlighted by Protector with other people running Xortify.');
	...
	define('_US_UNEEDAGREE', 'You did not aggree to the disclaimer, please read the disclaimer and click aggree if you do!');
?>